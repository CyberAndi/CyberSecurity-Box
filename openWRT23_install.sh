...
server=/google.com/swisscows.com#53
...
server=/swisscows.com/127.0.0.1#$(echo $DNS_UNBOUND_port)
server=/swisscows.de/127.0.0.1#$(echo $DNS_UNBOUND_port)
server=/swisscows.ch/127.0.0.1#$(echo $DNS_UNBOUND_port)
server=/swisscows.at/127.0.0.1#$(echo $DNS_UNBOUND_port)
