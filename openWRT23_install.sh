...
set uci unbound.ub_main.add_extra_dns='0'
set uci unbound.ub_main.add_local_fqdn='1'
set uci unbound.ub_main.add_wan_fqdn='0'
set uci unbound.ub_main.dhcp_link='dnsmasq'
set uci unbound.ub_main.dhcp4_slaac6='0'
set uci unbound.ub_main.dns64='0'
set uci unbound.ub_main.dns64_prefix='64:ff9b::/96'
set uci unbound.ub_main.domain='lan'
set uci unbound.ub_main.domain_type='static'
set uci unbound.ub_main.edns_size='1232'
set uci unbound.ub_main.extended_stats='0'
set uci unbound.ub_main.hide_binddata='1'
set uci unbound.ub_main.interface_auto='1'
set uci unbound.ub_main.listen_port='5353'
set uci unbound.ub_main.localservice='1'
set uci unbound.ub_main.manual_conf='0'
set uci unbound.ub_main.num_threads='1'
set uci unbound.ub_main.protocol='ip4_only'
set uci unbound.ub_main.query_minimize='1'
set uci unbound.ub_main.query_min_strict='1'
set uci unbound.ub_main.rate_limit='0'
set uci unbound.ub_main.rebind_localhost='0'
set uci unbound.ub_main.rebind_protection='1'
set uci unbound.ub_main.recursion='default'
set uci unbound.ub_main.resource='default'
set uci unbound.ub_main.root_age='9'
set uci unbound.ub_main.ttl_min='120'
set uci unbound.ub_main.ttl_neg_max='1000'
set uci unbound.ub_main.unbound_control='2'
set uci unbound.ub_main.validator='0'
set uci unbound.ub_main.validator_ntp='1'
set uci unbound.ub_main.verbosity='1'
set uci unbound.ub_main.iface_trig='lan' 'wan'
set uci unbound.ub_main.iface_wan='wan'
add_list uci unbound.ub_main.outgoing_port_permit='53'
add_list uci unbound.ub_main.outgoing_port_permit='853'
add_list uci unbound.ub_main.outgoing_port_permit='9053'
add_list uci unbound.ub_main.outgoing_port_permit='9050'
set uci unbound.ub_main.qname_minimisation='yes'
set uci unbound.ub_main.qname_minimisation_strict='yes'
set uci unbound.ub_main.rrset_roundrobin='yes'
set uci unbound.ub_main.serve_expired='yes'
set uci unbound.ub_main.so_rcvbuf='1m'
set uci unbound.ub_main.msg_cache_slabs='2'
set uci unbound.ub_main.rrset_cache_slabs='2'
set uci unbound.ub_main.infra_cache_slabs='2'
set uci unbound.ub_main.key_cache_slabs='2'
set uci unbound.ub_main.use_caps_for_id='yes'
set uci unbound.ub_main.so_reuseport='yes'
set uci unbound.ub_main.prefetch='yes'
set uci unbound.ub_main.prefetch_key='yes'
#set uci unbound.auth_icann=zone
set uci unbound.auth_icann.enabled='1'
#set uci unbound.auth_icann.fallback='1'
#set uci unbound.auth_icann.url_dir='https://www.internic.net/domain/'
#set uci unbound.auth_icann.zone_type='auth_zone'
#set uci unbound.auth_icann.server='lax.xfr.dns.icann.org' 'iad.xfr.dns.icann.org'
#set uci unbound.auth_icann.zone_name='.' 'arpa.' 'in-addr.arpa.' 'ip6.arpa.'
set uci unbound.fwd_cloudflare.enabled='1'
