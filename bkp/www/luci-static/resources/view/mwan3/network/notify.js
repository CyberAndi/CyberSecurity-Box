...
_('Put your custom mwan3 action here, they will be executed with each netifd hotplug interface event on interfaces for which mwan3 is enabled.')+'<br />'+'<br />'+
_('There are three main environment variables that are passed to this script.')+'<br />'+'<br />'+
...
_('%s: Name of Physical device which interface went up or down (e.g. \"eth0\" or \"wwan0\")').format('$DEVICE')+'<br />'),E('p',{},E('textarea',{'style':'width:100%','rows':10,'disabled':isReadonlyView},[mwan3user!=null?mwan3user:'']))]);},handleSaveApply:null,handleReset:null});