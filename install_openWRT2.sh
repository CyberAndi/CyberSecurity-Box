...
uci add_list unbound.ub_main.trigger_interface='CONTROL'
uci add_list unbound.ub_main.trigger_interface='HCONTROL'
uci add_list unbound.ub_main.trigger_interface='INET_CLIENTS'
uci add_list unbound.ub_main.trigger_interface='SERVER'
uci add_list unbound.ub_main.trigger_interface='VOICE'
uci add_list unbound.ub_main.trigger_interface='ENTERTAIN'
uci add_list unbound.ub_main.trigger_interface='CMOVIE'
uci add_list unbound.ub_main.trigger_interface='GUEST'
uci add_list unbound.ub_main.trigger_interface='wan6'
