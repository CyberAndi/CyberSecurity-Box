...
{var button=input.parentNode.parentNode.querySelector('.cbi-button-add');button.disabled=input.value==='';}
...
{if(!RegExp)
return;var html_esc=[/&/g,'&#38;',/"/g,'&#34;',/'/g,'&#39;',/</g,'&#60;',/>/g,'&#62;'];var quot_esc=[/"/g,'&#34;',/'/g,'&#39;'];function esc(s,r){var t=typeof(s);if(s==null||t==='object'||t==='function')
return'';if(t!=='string')
s=String(s);for(var i=0;i<r.length;i+=2)
...
val/=mf;if(i)
subst=val.toFixed(pr)+units[i]+(mf==1024?'i':'');else
subst=val+' ';pMinLength=null;break;}}}
...
return;var t=L.dom.findClassInstance(target);if(!(t instanceof L.ui.Table)){t=new L.ui.Table(target);L.dom.bindClassInstance(target,t);}
...
L.hideTooltip(ev);});L.require('ui').then(function(ui){document.querySelectorAll('.table').forEach(cbi_update_table);});});